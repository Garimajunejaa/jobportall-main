...
export const getCompany = async (req, res) => {
    try {
        ...
        // Get all companies for admin view, not just user's companies
        const companies = await Company.find({}).sort({ createdAt: -1 });
        console.log('Companies found in DB:', companies.length);
        console.log('Companies data sample:', companies.slice(0, 2));
